...
import { AnalysisAnnotation, CreateAnalysisAnnotationData } from '@/hooks/useAnalysisAnnotations';
import { useAuth } from '@/hooks/useAuth';
import { AnnotationPopover } from './AnnotationPopover';
import { AnnotationHighlight } from './AnnotationHighlight';
import { createPortal } from 'react-dom';

interface AnnotatableAnalysisTextProps {
  content: string;
  fieldName: string;
  analysisId: string;
  annotations: AnalysisAnnotation[];
  onCreateAnnotation: (data: CreateAnalysisAnnotationData) => Promise<AnalysisAnnotation | null>;
...
export function AnnotatableAnalysisText({
  content,
  fieldName,
  analysisId,
  annotations,
  ...
  // Convert AnalysisAnnotation to the format expected by AnnotationHighlight
  const convertedAnnotations = useMemo(() => 
    sortedAnnotations.map(a => ({
      ...a,
      experiment_id: a.analysis_id, // Map for compatibility
    })),
    [sortedAnnotations]
  );
  ...
  const renderContent = () => {
    ...
    convertedAnnotations.forEach((annotation, idx) => {
